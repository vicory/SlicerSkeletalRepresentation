...
#ifndef VTKSLICERSREPINTERPOLATER_H
#define VTKSLICERSREPINTERPOLATER_H

class vtkSpoke;
class vtkSlicerSRepInterpolater
{
public:
    vtkSlicerSRepInterpolater();
...
#endif // VTKSLICERSREPINTERPOLATER_H
