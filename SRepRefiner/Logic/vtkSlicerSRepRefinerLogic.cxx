...
#include "vtkSlicerSRepInterpolater.h"
#include "vtkSrep.h"
#include "vtkSpoke.h"
#include "newuoa.h"
...
//----------------------------------------------------------------------------
vtkStandardNewMacro(vtkSlicerSRepRefinerLogic);

//----------------------------------------------------------------------------
vtkSlicerSRepRefinerLogic::vtkSlicerSRepRefinerLogic()
{
}
...
//----------------------------------------------------------------------------
void vtkSlicerSRepRefinerLogic::PrintSelf(ostream& os, vtkIndent indent)
{
    this->Superclass::PrintSelf(os, indent);
}

void vtkSlicerSRepRefinerLogic::SetImageFileName(const std::string &imageFilePath)
{
...
void vtkSlicerSRepRefinerLogic::SetSrepFileName(const std::string &srepFilePath)
{
...
void vtkSlicerSRepRefinerLogic::SetOutputPath(const string &outputPath)
{
    mOutputPath = outputPath;
}

void vtkSlicerSRepRefinerLogic::Refine(double stepSize, double endCriterion, int maxIter, int interpolationLevel)
{
    mFirstCost = true;
    // 1. parse file
...
void vtkSlicerSRepRefinerLogic::InterpolateSrep(int interpolationLevel,
...
void vtkSlicerSRepRefinerLogic::InterpolateSrep(int interpolationLevel, int nRows, int nCols,
                                                                  ...
                                                                  std::vector<vtkSpoke *> &interpolatedCrestSpokes)
{
    ...
    vtkSlicerSRepInterpolater interpolater;
...
void vtkSlicerSRepRefinerLogic::SetWeights(double wtImageMatch, double wtNormal, double wtSrad)
{
...
double vtkSlicerSRepRefinerLogic::operator ()(double *coeff)
{
    double cost = 0.0;
    cost = EvaluateObjectiveFunction(coeff);
    return cost;
}
double vtkSlicerSRepRefinerLogic::EvaluateObjectiveFunction(double *coeff)
{
...
void vtkSlicerSRepRefinerLogic::AntiAliasSignedDistanceMap(const std::string &meshFileName)
{
...
void vtkSlicerSRepRefinerLogic::TransformSrep(const std::string &headerFile)
{
...
void vtkSlicerSRepRefinerLogic::ShowImpliedBoundary(int interpolationLevel,
...
void vtkSlicerSRepRefinerLogic::CLIRefine(const std::string &srepFileName,
...
void vtkSlicerSRepRefinerLogic::ComputeDerivative(std::vector<double> skeletalPoints,
...
void vtkSlicerSRepRefinerLogic::ConvertSpokes2PolyData(std::vector<vtkSpoke *>input, vtkPolyData *output)
{
...
void vtkSlicerSRepRefinerLogic::SaveSpokes2Vtp(std::vector<vtkSpoke *> input, const string &path)
{
    vtkSmartPointer<vtkPoints> pts = vtkSmartPointer<vtkPoints>::New();
...
void vtkSlicerSRepRefinerLogic::TransSpokes2PolyData(std::vector<vtkSpoke *>input, vtkPolyData *output)
{
    vtkSmartPointer<vtkPoints> pts = vtkSmartPointer<vtkPoints>::New();
    vtkSmartPointer<vtkCellArray> arrows = vtkSmartPointer<vtkCellArray>::New();
...
void vtkSlicerSRepRefinerLogic::VisualizePoints(vtkPoints *input)
{
...
//---------------------------------------------------------------------------
void vtkSlicerSRepRefinerLogic::SetMRMLSceneInternal(vtkMRMLScene * newScene)
{
...
//-----------------------------------------------------------------------------
void vtkSlicerSRepRefinerLogic::RegisterNodes()
{
  assert(this->GetMRMLScene() != nullptr);
}

//---------------------------------------------------------------------------
void vtkSlicerSRepRefinerLogic::UpdateFromMRMLScene()
{
  assert(this->GetMRMLScene() != nullptr);
}

//---------------------------------------------------------------------------
void vtkSlicerSRepRefinerLogic
...
void vtkSlicerSRepRefinerLogic::Parse(const std::string &modelFileName, std::vector<double> &coeffArray,
...
void vtkSlicerSRepRefinerLogic::ParseHeader(const std::string &headerFileName, int *nRows, int *nCols,
...
void vtkSlicerSRepRefinerLogic::UpdateHeader(const string &headerFileName,
...
void vtkSlicerSRepRefinerLogic::ComputeDiff(double *head, double *tail, double factor, double *output)
{
...
double vtkSlicerSRepRefinerLogic::ComputeDistance(vtkSpoke *theSpoke, double *normalMatch)
{
...
void vtkSlicerSRepRefinerLogic::Visualize(vtkPolyData *model, const std::string &modelName,
...
void vtkSlicerSRepRefinerLogic::HideNodesByClass(const string &className)
{
...
void vtkSlicerSRepRefinerLogic::TransformSrep2ImageCS(vtkSrep *input, double mat4x4[][4])
{
    if(input->IsEmpty())
    {
        mat4x4 = nullptr;
...
void vtkSlicerSRepRefinerLogic::ConnectImpliedBoundaryPts(int interpolationLevel,int nRows, int nCols,
                                                               const string &srepFileName,
...
void vtkSlicerSRepRefinerLogic::ConnectImpliedCrest(int interpolationLevel,
...
void vtkSlicerSRepRefinerLogic::ConnectFoldCurve(const std::vector<vtkSpoke *> &edgeSpokes,
...
std::vector<vtkSpoke*>& vtkSlicerSRepRefinerLogic::RefinePartOfSpokes(const string &srepFileName, double stepSize, double endCriterion, int maxIter)
{
    mCoeffArray.clear();
...
void vtkSlicerSRepRefinerLogic::RefineCrestSpokes(const string &crest, double stepSize,
...
double vtkSlicerSRepRefinerLogic::TotalDistOfLeftTopSpoke(vtkSrep *tempSrep,
                                                                            double u, double v,
                                                                            int r, int c,
                                                                            double *normalMatch)
{
...
double vtkSlicerSRepRefinerLogic::TotalDistOfRightTopSpoke(vtkSrep *tempSrep,
                                                                             double u, double v,
                                                                             int r, int c,
                                                                             double *normalMatch)
{
...
double vtkSlicerSRepRefinerLogic::TotalDistOfLeftBotSpoke(vtkSrep *tempSrep,
                                                                            double u, double v,
                                                                            int r, int c,
                                                                            double *normalMatch)
{
...
double vtkSlicerSRepRefinerLogic::TotalDistOfRightBotSpoke(vtkSrep *tempSrep,
                                                                             double u, double v,
                                                                             int r, int c,
                                                                             double *normalMatch)
{
...
double vtkSlicerSRepRefinerLogic::ComputeRSradPenalty(vtkSrep *input)
{
    double penalty = 0.0;
    // Interpolate
    if(input->IsEmpty())
...
void vtkSlicerSRepRefinerLogic::FindTopLeftNeigbors(int r, int c,
                                                               vtkSrep* input,
...
void vtkSlicerSRepRefinerLogic::FindTopRightNeigbors(int r, int c, vtkSrep *input, std::vector<vtkSpoke *> &neighborU, std::vector<vtkSpoke *> &neighborV)
{
    vtkSlicerSRepInterpolater interpolater;
    int nRows = input->GetNumRows();
    int nCols = input->GetNumCols();
...
void vtkSlicerSRepRefinerLogic::FindBotLeftNeigbors(int r, int c,
                                                                      vtkSrep *input,
                                                                      std::vector<vtkSpoke *> &neighborU,
                                                                      std::vector<vtkSpoke *> &neighborV)
{
...
void vtkSlicerSRepRefinerLogic::FindBotRightNeigbors(int r, int c,
                                                                       vtkSrep *input,
                                                                       std::vector<vtkSpoke *> &neighborU,
                                                                       std::vector<vtkSpoke *> &neighborV)
{
...
void vtkSlicerSRepRefinerLogic::ParseCrest(const string &crestFileName,
...
void vtkSlicerSRepRefinerLogic::InterpolateCrest(std::vector<vtkSpoke *> &crestSpoke,
...
void vtkSlicerSRepRefinerLogic::ReorderCrestSpokes(int nRows, int nCols,
...
void vtkSlicerSRepRefinerLogic::OptimizeCrestSpokeLength(vtkImplicitPolyDataDistance *distanceFunction,
...
void vtkSlicerSRepRefinerLogic::Transform2ImageCS(double *ptInput, int *ptOutput)
{
...
void vtkSlicerSRepRefinerLogic::RetileMesh(vtkPolyData *targetMesh, vtkPolyData *impliedMesh,
