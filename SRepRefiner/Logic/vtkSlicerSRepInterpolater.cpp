...
vtkSlicerSRepInterpolater::vtkSlicerSRepInterpolater()
{

}

void vtkSlicerSRepInterpolater::Interpolate(double u, double v,
...
void vtkSlicerSRepInterpolater::InterpolateQuad(vtkSpoke **cornerSpokes,
                                                                  double u, double v,
...
void vtkSlicerSRepInterpolater::InterpolateSegment(vtkSpoke **endSpokes, double dist, double lambda, vtkSpoke *interpolatedSpoke)
{
    vtkSpoke* start = endSpokes[0];
    vtkSpoke* end = endSpokes[1];
...
bool vtkSlicerSRepInterpolater::InterpolateMiddleSpoke(vtkSpoke *startS, vtkSpoke *endS, double d, vtkSpoke *interpolatedSpoke)
{
...
void vtkSlicerSRepInterpolater::InterpolateSkeletalPoint(vtkSpoke **cornerSpokes,double u, double v, double *output)
{
    vtkSpoke* Sp11 = cornerSpokes[0];
    vtkSpoke* Sp21 = cornerSpokes[1];
    vtkSpoke* Sp22 = cornerSpokes[2];
...
void vtkSlicerSRepInterpolater::SetCornerDxdu(double *u11, double *u21, double *u22, double *u12)
{
...
void vtkSlicerSRepInterpolater::SetCornerDxdv(double *v11, double *v21, double *v22, double *v12)
{
...
void vtkSlicerSRepInterpolater::compute2ndDerivative(double *startU, double *endU, double *targetU, double d, double *output)
{
    double del = 1e-5;
...
void vtkSlicerSRepInterpolater::slerp(double *U1, double *U2, double u, double *output)
{
